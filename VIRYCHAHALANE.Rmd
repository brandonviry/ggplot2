...
Maintenant que les données sont récupérées je vais vous expliquer La nature qui contient ces données.C'est donner sont d'un type spécial a R **c'est tibble**.Un tibble est à **dataframe** où les **données** de chaque colonnes sont **typées**.
