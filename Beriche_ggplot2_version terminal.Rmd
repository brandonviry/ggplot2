...
ggplot(mpg, aes(x = displ, y = model, color = yellow, linetype = trans)) +
  geom_point(size = 1.5) +
  geom_line(alpha = 0.5)
...
Maintenant on va découper le graphe  en plusieurs sous graphiques séparément pour pouvoir isoler et interpréter chaque Notes et matière différemment, grâce au facet , ici j'ai choisi de les disposer par suite graphique grâce à la fonction facet_wrap.
